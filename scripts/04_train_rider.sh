...
python src/train_rider.py \
  ...
  --checkpoint ./checkpoints/rider/best.pth \
  --save_dir ./checkpoints/rider/reports \
  --metrics_json ./checkpoints/rider/metrics.json \
  --epoch_metrics_json ./checkpoints/rider/epoch_test_metrics.json \
  --epoch_test_text_log ./checkpoints/rider/epoch_test_by_model.txt \
